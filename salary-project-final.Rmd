...
>>>>>>> 9482a434801c149821186891c4a9de36c59f96a8
...
\[
<<<<<<< HEAD
\log(\text{salary}_{\text{usd}}) = \beta_0 
+ \beta_1\,\text{experience\_level} 
+ \beta_2\,\text{job\_title} 
+ \beta_3\,\text{employee\_residence}
+ \beta_4\,\text{work\_setting}
+ \beta_5\,\text{company\_size}
+ \beta_6\,(\text{experience\_level} \cdot \text{company\_size})
=======
