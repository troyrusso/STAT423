...
cat("Residuals:\n")
print(model_summary$residuals %>% summary())
cat("\n")

# Print only Model Fit Statistics
cat("Residual standard error:", model_summary$sigma, "on", model_summary$df[2], "degrees of freedom\n")
cat("Multiple R-squared:", model_summary$r.squared, "\n")
cat("Adjusted R-squared:", model_summary$adj.r.squared, "\n")
cat("F-statistic:", model_summary$fstatistic[1], "on", model_summary$fstatistic[2], "and", model_summary$fstatistic[3], "DF, p-value:", pf(model_summary$fstatistic[1], model_summary$fstatistic[2], model_summary$fstatistic[3], lower.tail = FALSE), "\n")
```
