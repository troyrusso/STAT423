...
\begin{table}[h]
    ...
    \begin{tabular}{|l|c|}
        ...
        \hline
        \multicolumn{2}{|c|}{\textbf{Log-Scale Results}} \\
        \hline
        MSE (log-scale) & 0.1589 \\
        RMSE (log-scale) & 0.3987 \\
        \hline
        \multicolumn{2}{|c|}{\textbf{Original Salary Scale}} \\
        \hline
...
The graph of our predicted salary vs actual salary shows that our model does capture much of the relationship, but there is still a lot of variation that our model is unable to capture still.
# 4. Discussion
